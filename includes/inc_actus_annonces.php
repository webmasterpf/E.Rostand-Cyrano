...
if ($view->result) {
  ...
  $output = '<div id="bloc_actus_annonces"><h3>'.$view->get_title().'</h3>' . $view->preview().'</div>';
//Affiche la vue
print $output;
}
...
elseif (empty($view->result)) {
    //Formatage du texte vide,ajout du titre de la vue
     $outputEmpty = '<div id="bloc_actus_annonces"><h3 class="titre-h3">'.$view->get_title().'</h3>'.$emptyText.'</div>';
